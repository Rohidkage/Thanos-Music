...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Rohidkage/Thanos-Music",
)
...
)  # Example:- https://t.me/kagestore69
...
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "Thanos-MusicLOGS.txt"
adminlist = {}
lyrical = {}
chatstats = {}
userstats = {}
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/20220927_084339.jpg":
...
if PLAYLIST_IMG_URL:
    if PLAYLIST_IMG_URL != "assets/20220927_084339.jpg":
...
if GLOBAL_IMG_URL:
    if GLOBAL_IMG_URL != "assets/20220927_084339.jpg":
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "assets/20220927_084339.jpg":
